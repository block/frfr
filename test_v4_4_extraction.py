"""
Test script for V4.4 extraction with validation skipping for auto-generated facts.

Tests that auto-generated facts bypass validation to achieve 35%+ QV coverage.
"""
...
# Write test file
test_file = Path("test_sample_v4_4.txt")
with open(test_file, "w") as f:
    f.write(test_text)

print("="*70)
print("V4.4 EXTRACTION TEST - Validation Skip for Auto-Generated Facts")
print("="*70)
print(f"\nTest file: {test_file}")
...
try:
    ...
    result = extractor.extract_from_document(
        text_file=test_file,
        document_name="test_sample_v4_4",
        session=session,
    )
    ...
    print("\n" + "="*70)
    if qv_coverage >= 35.0:
        print("SUCCESS! V4.4 ACHIEVES 35%+ QV COVERAGE")
    else:
